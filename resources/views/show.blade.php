            ...
            <div class="col-log-8">
               <form class="row g-3" action="{{url('/update/'.$data->id)}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-4">
                     ...
                     <input type="text" name="penerbit" class="form-control" placeholder="Penerbit" autocomplete="on" value="{{$data->penerbit}}">
                     {{-- Menampilkan Validasi--}}
                  ...
                  <div class="form-group p-2 d-flex justify-content-evenly">
                     <button type="sumbit" class="btn btn-outline-dark btn-primary" onclick="return confirm('Apakah kamu yakin ingin mengubah?')"><b>Edit Buku</b></button>
