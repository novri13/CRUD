            ...
            <div class="col-log-8">
               <form class="row g-3" action="{{url('/store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="col-auto">
                        <span id="judul_buku" class="form-text">
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="col-auto">
                        <span id="pengarang" class="form-text">
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="col-auto">
                        <span id="penerbit" class="form-text">
                  ...
                  <div class="col-md-3">
                     ...
                     <input type="number" name="harga" class="form-control" placeholder="Harga" autocomplete="on" value="{{old("harga")}}"> 
                     {{-- Menampilkan Validasi--}}
                     @if($errors->has('harga'))
                        <div class ="text-danger">
                           {{$errors->first('harga')}}
